...
// VK Smart Assistant Bot - WORKING ICS IMPORT
// Complete working version with fallback mechanisms
...
// Full multilingual support: English, Русский, 中文
// All features: Schedule, Tasks, ICS Import, Statistics, Attendance
// ============================================
...
const TRANSLATIONS = {
  en: {
    // Setup
    ask_name: "👋 Hello! I'm your academic assistant. What's your name?",
    got_name: "🎉 Nice to meet you, {name}! I'll help you manage your schedule and tasks!",
    greeting: "👋 Hey {name}! Ready to stay organized?",
    
    // Schedule
    schedule_empty: "📭 Your schedule is empty. Use /add or send an ICS file.",
    schedule_header: "📅 **Your Schedule**\n\n",
    schedule_item: "🆔 {id} | {day} | {start}-{end}\n   📖 {subject}\n   📍 {location}\n   🗑️ /delete {id}\n\n",
    today_header: "📋 **Today's Classes**\n\n",
    tomorrow_header: "📅 **Tomorrow's Classes**\n\n",
    no_classes: "🎉 No classes today! Enjoy your day!",
    no_classes_tomorrow: "🎉 No classes tomorrow! Time to relax!",
    next_class: "⏰ **Next Class**\n\n📖 {subject}\n📅 {day}\n🕐 {time}\n⏱️ Starts in {minutes} minutes!",
    ...
    stats_classes: "📚 **Schedule**\n   • Total classes: {count}\n\n",
    stats_tasks: "📝 **Tasks**\n   • Completed: {completed}\n   • Pending: {pending}\n   • Total: {total}\n   • Completion rate: {rate}%\n\n",
    stats_motivation_pending: "🎯 Focus on completing your {count} pending task(s)!",
    stats_motivation_classes: "📅 Keep up with your {count} classes!",
    stats_motivation_start: "💡 Add some classes or tasks to get started!",
    
    // Attendance
    attendance_marked: "✅ Attendance marked for {class_name}!",
    attendance_error: "❌ Couldn't mark attendance.",
    attendance_prompt: "📚 Which class did you attend?\n\n{classes}\n\nReply with the number or name.",
    attendance_stats: "📅 Attendance: {attended}/{total} ({rate}%)",
    
    // Help
    help_text: `🤖 **Smart Assistant Bot - Help**
...
Days: 0=Mon, 1=Tue, 2=Wed, 3=Thu, 4=Fri, 5=Sat, 6=Sun`,
    ...
    // Unknown
    unknown: "🤔 How can I help? Type 'Help' to see commands.",
  ...
  ru: {
    ...
    today_header: "📋 **Пары сегодня**\n\n",
    tomorrow_header: "📅 **Пары завтра**\n\n",
    no_classes: "🎉 Сегодня нет пар! Отдыхай!",
    no_classes_tomorrow: "🎉 Завтра нет пар! Отдыхай!",
    next_class: "⏰ **Следующая пара**\n\n📖 {subject}\n📅 {day}\n🕐 {time}\n⏱️ Через {minutes} минут!",
    ...
    import_success: "✅ Успех! Импортировано {count} пар(ы) в расписание!",
    import_fail: "❌ Ошибка импорта.\n\nОшибка: {error}\n\n💡 Попробуй скачать ICS файл и отправить его напрямую.",
    import_instructions: "📥 **Импорт расписания**\n\nОтправь ICS ссылку:\n`/ics <url>`\n\nИли прикрепи .ics файл напрямую.",
    
    stats_header: "📊 **Твоя статистика**\n\n",
    stats_classes: "📚 **Расписание**\n   • Всего пар: {count}\n\n",
    stats_tasks: "📝 **Задачи**\n   • Выполнено: {completed}\n   • Ожидает: {pending}\n   • Всего: {total}\n   • Выполнение: {rate}%\n\n",
    stats_motivation_pending: "🎯 Сосредоточься на выполнении {count} задачи(ей)!",
    stats_motivation_classes: "📅 Продолжай посещать свои {count} пар(ы)!",
    stats_motivation_start: "💡 Добавь пары или задачи чтобы начать!",
    
    attendance_marked: "✅ Посещение отмечено для {class_name}!",
    attendance_error: "❌ Не удалось отметить посещение.",
    attendance_prompt: "📚 Какую пару ты посетил?\n\n{classes}\n\nОтветь номером или названием.",
...
Дни: 0=Пн, 1=Вт, 2=Ср, 3=Чт, 4=Пт, 5=Сб, 6=Вс`,
  ...
  zh: {
    ...
    schedule_empty: "📭 课程表为空。使用 /add 或发送ICS文件。",
    schedule_header: "📅 **你的课程表**\n\n",
    schedule_item: "🆔 {id} | {day} | {start}-{end}\n   📖 {subject}\n   📍 {location}\n   🗑️ /delete {id}\n\n",
    today_header: "📋 **今日课程**\n\n",
    tomorrow_header: "📅 **明日课程**\n\n",
    no_classes: "🎉 今天没课！好好休息！",
    no_classes_tomorrow: "🎉 明天没课！好好休息！",
    next_class: "⏰ **下一节课**\n\n📖 {subject}\n📅 {day}\n🕐 {time}\n⏱️ {minutes}分钟后开始！",
    ...
    import_start: "⏳ 正在导入课程表... 请稍候。",
    import_success: "✅ 成功！已导入 {count} 节课到你的课程表！",
    import_fail: "❌ 导入失败。\n\n错误：{error}\n\n💡 尝试下载ICS文件并直接发送。",
    import_instructions: "📥 **导入课程表**\n\n发送ICS链接：\n`/ics <url>`\n\n或直接附加.ics文件。",
    ...
    stats_classes: "📚 **课程表**\n   • 总课程：{count}\n\n",
    stats_tasks: "📝 **任务**\n   • 已完成：{completed}\n   • 待完成：{pending}\n   • 总计：{total}\n   • 完成率：{rate}%\n\n",
    stats_motivation_pending: "🎯 专注于完成 {count} 个待办任务！",
    stats_motivation_classes: "📅 坚持上完 {count} 节课！",
    stats_motivation_start: "💡 添加一些课程或任务开始吧！",
    
    attendance_marked: "✅ 已标记 {class_name} 的出勤！",
    attendance_error: "❌ 无法标记出勤。",
    attendance_prompt: "📚 你上了哪节课？\n\n{classes}\n\n回复课程编号或名称。",
...
async function getOrCreateUser(userId, detectedLang = "en") {
  ...
  const { data: newUser, error } = await supabase
    .from("users")
    .insert({ vk_id: userId, name: "Student", language: detectedLang })
    .select()
    .single();
...
async function addTask(userId, title, dueDate) {
  const { error } = await supabase.from("tasks").insert({
    user_id: userId, title, due_date: dueDate, completed: false
  });
  if (!error) clearCache(userId);
  return !error;
}
...
async function processMessage(userId, messageText, lang) {
  ...
  if (text === "📊 Stats" || text === "📊 Статистика" || text === "📊 统计" || lowerText === "stats") {
    ...
    msg += t("stats_classes", { count: classes.length });
    msg += t("stats_tasks", {
    ...
    if (pendingTasks.length > 0) {
      msg += t("stats_motivation_pending", { count: pendingTasks.length });
    } else if (classes.length > 0) {
      msg += t("stats_motivation_classes", { count: classes.length });
    } else {
      msg += t("stats_motivation_start");
    }
  ...
  if (lowerText.startsWith("/task")) {
    ...
    if (match) {
      ...
      const success = await addTask(userId, title, dueDate);
      
      if (success) {
        await sendMessage(userId, t("task_added", { title, due_date: dueDate }), getMainKeyboard(lang));
      } else {
        await sendMessage(userId, "❌ Error adding task", getMainKeyboard(lang));
      }
    } else {
  ...
  if (lowerText.startsWith("/ics")) {
    ...
    if (parts.length >= 2) {
      ...
      if (result.success && result.count > 0) {
        await sendMessage(userId, t("import_success", { count: result.count }), getMainKeyboard(lang));
      } else {
...
export async function handler(event) {
  try {
    ...
    if (body.type === "message_new") {
      ...
      if ((!user?.name || user.name === "Student") && !nameMatch && !text.startsWith("/") && !text.includes("📅") && !text.includes("📝")) {
      ...
      if (icsAttachment) {
        ...
        try {
          ...
          if (result.success && result.count > 0) {
            const successMsg = getTranslation(userLang, "import_success", { count: result.count });
